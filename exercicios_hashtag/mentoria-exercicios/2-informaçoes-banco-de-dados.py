...
# CRIANDO A LISTA DE COLUNAS A PARTIR DAS INFORMAÇÕES IMPORTADAS DO BANCO DE DADOS
colunas = [tupla[0] for tupla in descricao]

# PASSANDO A INFORMAÇÃO DA LISTA PARA CRIAR OS NOMES DAS COLUNAS NO DATAFRAME
tabela = pd.DataFrame.from_records(informacoes, columns=colunas)

# ESCREVENDO O EMAIL E CONCATENANDO COM OS NOMES E CARGOS EXTRAÍDOS DA TUPLA ATRAVÉS DO FOR
